...
Exp1=$(curl https://raw.githubusercontent.com/Genome26/bio_hazard/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Genome26/bio_hazard/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Genome26/bio_hazard/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Genome26/bio_hazard/main/izin | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/Genome26/bio_hazard/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
